...
class Create extends Component
{
    ...
    protected $rules = [
        ...
        'questions.*.correctAnswer' => 'required|string|max:255',
    ...
    protected $validationAttributes = [
        ...
        'questions.*.points' => 'Bobot Soal', // Label untuk validasi bobot
    ];
    ...
    protected $messages = [
        ...
        'in' => ':attribute harus salah satu dari :values.', // Pesan untuk validasi 'in'
    ];
